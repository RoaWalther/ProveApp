...
// despues otra ves alt + enter para crear el constructor
...
// colocamos el nombre que queramos en el metodo onCreate yo le puse BaseDeDatos
    @Override
    public void onCreate(SQLiteDatabase BaseDeDatosClientes) {

        // asi se crea una base de datos 1 el nombre que le pusimos + el ."execSQL"
        BaseDeDatosClientes.execSQL("create table clientes(codigo int primary key, descripcion text)");
    }
